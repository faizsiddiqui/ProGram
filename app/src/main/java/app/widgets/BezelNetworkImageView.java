...
/**
 * Not for public use
 * Created by FAIZ on 28-04-2015.
 */
public class BezelNetworkImageView extends NetworkImageView {
    ...
    public BezelNetworkImageView(Context context) {
        this(context, null);
    }

    public BezelNetworkImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BezelNetworkImageView(Context context, AttributeSet attrs, int defStyle) {
